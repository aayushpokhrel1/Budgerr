...
Snapshot for whoever picks this up next — the working set is three repos (`~/dev/Budgerr` backend, `~/dev/budgerr-web`, `~/dev/BudgerrApp`), all on clean pushed `main`; backend suite is **63 passing tests** (53 + 6 playstat proxy + 4 auth).
