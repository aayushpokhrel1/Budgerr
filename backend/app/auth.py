"""API-key authentication for the Budgerr API.
...
- BUDGERR_API_KEYS: comma-separated "name:key" pairs, e.g.
  "web:abc123,mobile:def456,cron:ghi789". Names exist only for provisioning
...
# anything that touches app config, whose settings loading is what
